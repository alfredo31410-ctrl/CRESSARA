/** Panel privado para consultar, crear, actualizar y eliminar cursos. */
...
export default function AdminDashboard() {
  ...
  return (
    <div data-testid="admin-dashboard-page" className="min-h-screen bg-brand-bg">
      {/* Barra superior con identidad, usuario y cierre de sesión. */}
      ...
      {/* Formulario compartido para crear o editar un curso. */}
      ...
      {/* Confirmación separada para evitar eliminaciones accidentales. */}
